 ...
 * @Last Modified time: 2018-07-16 15:33:00
 */
import Vue from 'vue'
...
export default {
    ...
    methods: {
        ...
        getFriend() { // 获取朋友列表
            this.axios.get('/wechatauth/friend/search', {
                params: {
                    limit: this.limit,
                ...
                if (res.data.result) {
                    ...
                    this.friendlist = [...this.friendlist, ..._list];
                    this.pageSize = res.data.datas.total
                    this.totalProfit = res.data.datas.totalProfit
